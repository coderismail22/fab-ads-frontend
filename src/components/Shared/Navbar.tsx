        ...
        <section className="flex items-center justify-center gap-8 xl:gap-16 2xl:gap-20 text-center">
          ...
          {navitems.map((item, index) => (
            <Link
              key={index}
              to={item.path}
              className="relative hidden lg:inline-block  font-bold text-center text-sm md:text-base w-[75px] text-black transition-all duration-300 hover:text-blue-500 
